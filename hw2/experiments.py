...
def run_experiment(
    ...
    pooling_type = 'avg',
    pooling_params =dict(kernel_size=2) , #3?
    ...
    **kw,
    ...
    fit_res = trainer.fit(train_data_loader, test_data_loader, \
    epochs, max_batches=batches, print_every=1,early_stopping=early_stopping)
